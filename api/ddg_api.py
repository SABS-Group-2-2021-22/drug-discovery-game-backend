...
def sketcher_choose_molecule():
    ...
    :rtype: json dict
    """
    chosen_mol[0] = request.args.get('id')
    chosen_mol[1] = request.args.get('smiles')
    return jsonify({'chosen_mol': chosen_mol})


@app.route("/sketcher_comparisontxt")
def sketcher_comparison_txt():
...
def sketcher_return_spider_data():
